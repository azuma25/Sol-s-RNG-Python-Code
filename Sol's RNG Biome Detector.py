...
root.geometry("440x220")  # Adjusted size to fit the new layout
...
link_entry.insert(0, "https://www.roblox.com/games/15532962292/Sols-RNG-Eon1-1?privateServerLinkCode=59517081549248619364262668240229")
...
webhook_entry.insert(0, "https://discord.com/api/webhooks/1313612398158155877/ca7Bh_FYkRzsBwga3uUIxzA76FUuFGQHGyb9ctUqtinvkeRwOp69-ArPihM6XSMqaPbm")
...
footer_label.grid(row=4, column=0, columnspan=2, pady=0)
def open_reedzylx():
